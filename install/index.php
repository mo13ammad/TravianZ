...
$tz=(isset($_GET['t']))? (int)$_GET['t'] : 14;
    switch($tz) {
		...
		case 14: $t_zone="Asia/Tehran";break;
		default: $t_zone="Asia/Tehran";break;
    }
...
<head>
	<title>nalooti Installation</title>
	...
	<div class="wrapper">
		...
		<div id="mid">
			<div id="side_navi">
				...
				<span class="f18 c5">nalooti Installation Script</span>
				</center></div>
