...
$dbHost = $envDefaults['DB_HOST'] ?? ($envDefaults['DATABASE_HOST'] ?? 'localhost');
$dbPort = $envDefaults['DB_PORT'] ?? ($envDefaults['DATABASE_PORT'] ?? '3306');
$dbUser = $envDefaults['DB_USERNAME'] ?? ($envDefaults['DATABASE_USERNAME'] ?? ($envDefaults['MARIADB_USER'] ?? ($envDefaults['MYSQL_USER'] ?? '')));
$dbPass = $envDefaults['DB_PASSWORD'] ?? ($envDefaults['DATABASE_PASSWORD'] ?? ($envDefaults['MARIADB_PASSWORD'] ?? ($envDefaults['MYSQL_PASSWORD'] ?? '')));
$dbName = $envDefaults['DB_DATABASE'] ?? ($envDefaults['DATABASE_NAME'] ?? ($envDefaults['MARIADB_DATABASE'] ?? ($envDefaults['MYSQL_DATABASE'] ?? '')));
...
<form action="process.php" method="post" id="dataform">
    ...
    <table>
        <tr>
            ...
            <td width="140">
                <input type="text" name="servername" id="servername" value="nalooti">
            </td>
        </tr>
        <tr>
            <td>
    ...
    <!-- <RIGHT BOX - GPACK RELATED>
        ...
        <span class="f9 c6 c2">GPack Design:</span><span class="c3"><select name="gp_locate">
          ...
          <option value="gpack/travianx_v1/">nalooti v1 by Dzoki</option></select></span><br /><br />
        ...
        <tr>
            ...
            <td>
                <select name="qtype">
                    ...
                    <option value="37">nalooti Extended</option>
                </select>
            </td>
        </tr>
        <tr>
