...
?>
<p>
<center><font size="4"><a href="<?php echo HOMEPAGE; ?>">> My nalooti homepage <</font></a></center>
</p>
</br>
<center>
...
<input type="image" src="https://www.paypalobjects.com/en_US/GB/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal Ã¢â‚¬â€œ The safer, easier way to pay online!">
