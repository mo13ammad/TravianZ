...
//if(isset($_GET['c']))
//{
//	copy("https://raw.github.com/yi12345/nalooti/master/Admin/Templates/update_latest.tpl", "Templates/update_latest.tpl");
//}
...
<table id="member" cellpadding="1" cellspacing="1" >
	...
	<tbody>
		...
		<td class="hab" colspan="1"><?php
			if($latest > $ver)
			{
				echo'<center><a href="https://Nalooti.ir"><img src="../img/admin/b/update.png"></a></center>'; 
			} 
			else
			{ 
