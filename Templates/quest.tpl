...
<div id="qge">
    ...
    <img onclick="qst_handle();" src="<?php echo GP_LOCATE; ?>img/q/l<?php echo $session->userinfo['tribe'];?>g.jpg" title="<?php echo TO_THE_TASK; ?>" style="height:174px" alt="<?php echo TO_THE_TASK; ?>" />
    <?php }else{?>
    <img onclick="qst_handle();" src="<?php echo GP_LOCATE; ?>img/q/l<?php echo $session->userinfo['tribe'];?>.jpg" title="<?php echo TO_THE_TASK; ?>" style="height:174px" alt="<?php echo TO_THE_TASK; ?>" />
    <?php } ?>
</div>
