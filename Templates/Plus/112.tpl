...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
			<td class="pic">
                <img src="img/bezahlung/zarinpal.png" style="99px; height:99px;" alt="Package C" />
    
                <div>
                    Gold : <?php echo (defined('PLUS_PACKAGE_C_GOLD') ? PLUS_PACKAGE_C_GOLD : 360); ?>
                    <br />
                    Cost : <?php echo (defined('PLUS_PACKAGE_C_PRICE') ? PLUS_PACKAGE_C_PRICE : '20000') . ' ' . (defined('PAYMENT_CURRENCY') ? PAYMENT_CURRENCY : 'Toman'); ?>
                    <br />
                    Wait: Instant
                </div>
                </td>
                <td class="desc">
                    ...
                    <form action="zarinpal.php" method="post">
                      ...
                      <input type="hidden" name="amount" value="<?php echo (defined('PLUS_PACKAGE_C_PRICE') ? str_replace(",", "", PLUS_PACKAGE_C_PRICE) : '20000'); ?>">
