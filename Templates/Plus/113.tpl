...
<table class="rate_details lang_ltr lang_de" cellpadding="1" cellspacing="1">
	...
	<tbody>
		<tr>
			<td class="pic">
                <img src="img/bezahlung/zarinpal.png" style="99px; height:99px;" alt="Package D" />
    
                <div>
                    Gold : <?php echo (defined('PLUS_PACKAGE_D_GOLD') ? PLUS_PACKAGE_D_GOLD : 1000); ?>
                    <br />
                    Cost : <?php echo (defined('PLUS_PACKAGE_D_PRICE') ? PLUS_PACKAGE_D_PRICE : '50000') . ' ' . (defined('PAYMENT_CURRENCY') ? PAYMENT_CURRENCY : 'Toman'); ?>
                    <br />
                    Wait: Instant
                </div>
                </td>
                <td class="desc">
                    ...
                    <form action="zarinpal.php" method="post">
                      ...
                      <input type="hidden" name="amount" value="<?php echo (defined('PLUS_PACKAGE_D_PRICE') ? str_replace(",", "", PLUS_PACKAGE_D_PRICE) : '50000'); ?>">
